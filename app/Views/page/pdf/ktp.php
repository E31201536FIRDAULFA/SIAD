...
<div class="container">
  ...
  <hr class="garis1">
  <div id="jenis">
    <h3><u>SURAT PENGANTAR KTP</u></h3>
    <p style="text-align: center;">NOMOR :&emsp; &emsp; &emsp; &emsp; &emsp; &emsp;/25.2002/2003</p>
  </div>
<br>
  <div id="pembuka"> Kami PJ Kepala Desa Panduman Kecamatan Jelbuk Jember, menerangkan dengan sebenarnya bahwa :</div>
  <div id="tempat-tgl">
    <table>
      <tr>
        <td>NIK</td>
  ...
  <div id="penutup">Orang tersebut di atas hendak mengajukan pembuatan ktp dengan dibantunya surat pengantar ini sebagai pendaming blanko ktp.</div>
