      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <a class="btn bg-gradient-dark mb-0" href="<?= base_url('dashboard/riwayat/rktp') ?>">Cek Riwayat</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
            <a class="btn bg-gradient-success mb-0" href="<?= base_url('dashboard/riwayat/rkehilangan') ?>">Cek Riwayat</a>
            </div>
          </div>
        </div>
